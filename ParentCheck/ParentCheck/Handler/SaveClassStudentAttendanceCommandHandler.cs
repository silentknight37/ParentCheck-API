...
{
    public class SaveClassStudentAttendanceCommandHandler : IRequestHandler<SaveClassStudentAttendanceCommand, RequestSaveEnvelop>
    {
        private readonly IClassRoomFactory classRoomFactory;

        public SaveClassStudentAttendanceCommandHandler(ParentCheckContext parentcheckContext)
        {
            this.classRoomFactory = new ClassRoomFactory(parentcheckContext);
        }

        public async Task<RequestSaveEnvelop> Handle(SaveClassStudentAttendanceCommand saveClassStudentAttendanceCommand,CancellationToken cancellationToken)
        {
